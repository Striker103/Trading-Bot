...
"""
Title: FTX Sample Code
Author: FTX
Date: 2022
Availability: https://github.com/ftexchange/ftx/blob/master/rest/client.py
"""


class FtxClient:
    """ Handles the API calls. For further information visit https://docs.ftx.com/#overview"""

    _ENDPOINT = 'https://ftx.com/api/'

    def __init__(self, api_key=None, api_secret=None, sub_account_name=None) -> None:
        self.AccountCall = False if api_key is None and api_secret is None else True
    ...
    def _sign_request(self, request: Request) -> None:
        ...
        if self._sub_account_name:
            request.headers['FTX-SUBACCOUNT'] = urllib.parse.quote(self._sub_account_name)
    ...
    def get_single_future(self, market: str) -> dict:
        return self._get(f'futures/{market}')

    def get_orderbook(self, market: str, depth: int = None) -> dict:
        return self._get(f'markets/{market}/orderbook', {'depth': depth})

    def get_historical_prices(self, market: str, resolution: float, start_time: float = None,
                              end_time: float = None,) -> List[dict]:
        return self._get(f'markets/{market}/candles',
                         {'resolution': resolution, 'start_time': start_time, 'end_time': end_time})

    def get_historical_trades(self, market: str, start_time: float = None, end_time: float = None,) -> List[dict]:
    ...
    def get_future_account_info(self) -> dict:
        return self._get(f'account')

    def get_future_positions(self) -> dict:
    ...
    def place_order(self, market: str, side: str, size: float, price: float = None, type: str = None,
    ...
    def change_leverage(self, leverage: str):
        self._post(f'account/leverage/{leverage}')
