...
class RSITradingBacktestInterval(tk.Frame):
    def __init__(self, main_controller, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        self.rsi_trading_backtest = main_controller.get_rsi_controller_backtest()
        ...
        tk.Label(self, text="overbought at (0-100): ", bg='gray30', fg='white').place(x=400, y=50)
        self.user_input_overbought_lower = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_overbought_lower.place(x=550, y=50)
        self.user_input_overbought_upper = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_overbought_upper.place(x=625, y=50)
        self.user_input_overbought_interval = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_overbought_interval.place(x=700, y=50)

        tk.Label(self, text="oversold at (0-100): ", bg='gray30', fg='white').place(x=400, y=80)
        self.user_input_oversold_lower = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_oversold_lower.place(x=550, y=80)
        self.user_input_oversold_upper = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_oversold_upper.place(x=625, y=80)
        self.user_input_oversold_interval = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_oversold_interval.place(x=700, y=80)

        tk.Label(self, text="take profit: ", bg='gray30', fg='white').place(x=400, y=110)
        self.user_input_take_profit_lower = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_take_profit_lower.place(x=550, y=110)
        self.user_input_take_profit_upper = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_take_profit_upper.place(x=625, y=110)
        self.user_input_take_profit_interval = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_take_profit_interval.place(x=700, y=110)

        tk.Label(self, text="stop loss: ", bg='gray30', fg='white').place(x=400, y=140)
        self.user_input_stop_loss_lower = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_stop_loss_lower.place(x=550, y=140)
        self.user_input_stop_loss_upper = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_stop_loss_upper.place(x=625, y=140)
        self.user_input_stop_loss_interval = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_stop_loss_interval.place(x=700, y=140)

        tk.Label(self, text="days to backtest(1-365): ", bg='gray30', fg='white').place(x=400, y=170)
        self.user_input_days_lower = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_days_lower.place(x=550, y=170)
        self.user_input_days_upper = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_days_upper.place(x=625, y=170)
        self.user_input_days_interval = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_days_interval.place(x=700, y=170)

        tk.Label(self, text="length(1-50): ", bg='gray30', fg='white').place(x=400, y=200)
        self.user_input_length_lower = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_length_lower.place(x=550, y=200)
        self.user_input_length_upper = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_length_upper.place(x=625, y=200)
        self.user_input_length_interval = tk.Entry(self, bg='gray40', fg='white', width=10)
        self.user_input_length_interval.place(x=700, y=200)

        tk.Label(self, text="Example: take profit lower = 1.5, upper = 2.25, interval = 0.25 \n means backtest will "
                            "be done with 1.5,1.75,2.0 and 2.25", bg='gray30', fg='white').place(x=400, y=220)
    ...
    def on_click_delete_backtest(self):
        ...
        self.rsi_trading_backtest.stop = True
    ...
    def on_click_start_backtesting(self):
        self.rsi_trading_backtest.start_multiple_backtest(self,
                                                          ...
                                                          self.user_input_overbought_lower.get(),
                                                          self.user_input_overbought_upper.get(),
                                                          self.user_input_overbought_interval.get(),
                                                          self.user_input_oversold_lower.get(),
                                                          self.user_input_oversold_upper.get(),
                                                          self.user_input_oversold_interval.get(),
