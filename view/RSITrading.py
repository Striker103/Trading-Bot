...
class RSITrading(tk.Frame):
    def __init__(self, main_controller, parent, controller):
        ...
        self.rsi_trading = main_controller.get_rsi_controller()
        ...
        self.user_input_overbought = tk.Entry(self, bg='gray40', fg='white')
        self.user_input_overbought.place(x=550, y=50)

        tk.Label(self, text="oversold at (0-100): ", bg='gray30', fg='white').place(x=400, y=80)
        self.user_input_oversold = tk.Entry(self, bg='gray40', fg='white')
        self.user_input_oversold.place(x=550, y=80)
        ...
        self.user_input_take_profit.place(x=550, y=110)
        ...
        self.user_input_stop_loss.place(x=550, y=140)

        self.error_text_value = ""
        self.error_text = tk.Label(self, bg='gray30', text=self.error_text_value, fg="red")
        self.error_text.place(x=380, y=250)
        self.error_text.config(font=("arial bold", 12))

        tk.Label(self, bg='gray30', fg='white', text="Total collateral: ").place(x=400, y=170)
        self.total_collateral_value = ""
        self.total_collateral_text = tk.Label(self, text=self.total_collateral_value, bg='gray30', fg='white')
        self.total_collateral_text.place(x=550, y=170)

        tk.Label(self, bg='gray30', fg='white', text="Free collateral: ").place(x=400, y=200)
        self.free_collateral_value = ""
        self.free_collateral_text = tk.Label(self, text=self.free_collateral_value, bg='gray30', fg='white')
        self.free_collateral_text.place(x=550, y=200)

        tk.Label(self, text="leverage: ", bg='gray30', fg='white').place(x=400, y=230)
        self.leverage_value = ""
        self.leverage_text = tk.Label(self, text=self.leverage_value, bg='gray30', fg='white')
        self.leverage_text.place(x=550, y=230)
        ...
        tk.Button(self, bg='gray30', fg='white', text="Stop Trading Bot",
                  command=self.on_click_close_position).place(x=250, y=250)
    ...
    def menubar(self, root):
        ...
        self.update_relevant_data()
        return menubar

    def update_list_box(self):
        strategies = self.rsi_trading.get_all_names()
    ...
    def on_click_close_position(self):
        ...
        for index in i:
            self.rsi_trading.delete_strategy(self, index)

    def show_error_massage(self, massage):
        self.error_text.config(text=massage)

    def update_relevant_data(self):
        pass

    def on_click_start(self):
        self.rsi_trading.add_rsi_strategy(self,
                                          ...
                                          self.user_input_overbought.get(),
                                          self.user_input_oversold.get(),
                                          self.time_frame.get(),
