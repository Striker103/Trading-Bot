...
class RSITradingBacktest(tk.Frame):
    def __init__(self, main_controller, parent, controller):
        ...
        rsi_backtest_strategies = main_controller.get_account().get_rsi_backtest_strategy()
        for strategy in rsi_backtest_strategies:
            strategy.frame = self
        ...
        tk.Label(self, text="trading fees: ", bg='gray30', fg='white').place(x=400, y=170)
        self.user_input_trading_fees = tk.Entry(self, bg='gray40', fg='white')
        self.user_input_trading_fees.place(x=550, y=170)

        tk.Label(self, text="days to backtest(1-365): ", bg='gray30', fg='white').place(x=400, y=200)
        self.user_input_days = tk.Entry(self, bg='gray40', fg='white')
        self.user_input_days.place(x=550, y=200)
    ...
    def update_list_box(self):
        strategies = self.rsi_trading_backtest.get_all_rsi_backtest_strategies()
    ...
    def on_click_delete_backtest(self):
        ...
        for i in index:
            self.rsi_trading_backtest.delete_strategy(self, i)

    def on_click_delete_all(self):
        self.rsi_trading_backtest.delete_all_strategies(self)

    def show_error_massage(self, massage):
        self.error_text.config(text=massage)

    def on_click_start_backtesting(self):
        self.rsi_trading_backtest.start_single_backtest(self,
